"""LifePlan Advisor · Streamlit entrypoint."""

import os
import streamlit as st

st.set_page_config(page_title='LifePlan Advisor', layout='wide', initial_sidebar_state='expanded')
...
[data-testid="stAppViewContainer"] > .block-container { padding: 0 2rem 0 2rem !important; max-width: 1440px; }
.block-container { max-width: 1440px; padding-left: 1.5rem !important; padding-right: 1.5rem !important; }
...
.advisor-steps {
    ...
    gap: 0.5rem; margin: 1rem 0 1.25rem 0;
}
.advisor-step {
    display: flex; align-items: center; justify-content: center;
    min-height: 2.25rem; padding: 0.45rem 0.75rem;
...
NAV = {
    'zh': {
        ...
        'sidebar_brand': 'LifePlan Advisor',
...
pages = [
    ...
    st.Page('pages/14_Product_Compare.py', title=L['product_compare'], url_path='Product_Compare'),
    st.Page('pages/15_Sensitivity.py', title=L['sensitivity'], url_path='Sensitivity'),
]
