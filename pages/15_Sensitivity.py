...
from ui_components import render_home_nav, section_panel
...
if st.button(t('run'), type='primary', use_container_width=True):
    ...
    st.info(t('insight_text',
        ...
        v_lo=v_lo, v_hi=v_hi, v_delta=pct, direction=direction))
