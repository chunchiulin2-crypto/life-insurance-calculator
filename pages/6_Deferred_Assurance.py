...
from validation import validate_coverage_window, validate_deferment
...
render_metric_row([
    {'label': f'{t("per_payment")} ({freq_label})', 'value': f'¥{payment:,.0f}', 'help': summary},
    {'label': t('annual_premium'), 'value': f'¥{ap:,.0f}'},
    {'label': t('lump_sum'), 'value': f'¥{sp:,.0f}'},
])
...
with section_panel(t('deferral_vs_coverage')):
